...
MAJOR_FESTIVALS = {
    ...
    # Дополнения после полного аудита (Phase 2)
    'Lord Balarama -- Appearance':                        'Баларама-пурнима — Явление Господа Баларамы',
    'Sri Vamana Dvadasi: Appearance of Lord Vamanadeva':  'Вамана-двадаши — Явление Господа Ваманы',
    'Srila Prabhupada -- Disappearance':                  'Шрила Прабхупада — Уход',
    'Srila Gaura Kisora Dasa Babaji -- Disappearance':    'Шрила Гауракишора Даса Бабаджи — Уход',
    'Srila Haridasa Thakura -- Disappearance':            'Шрила Харидаса Тхакур — Уход',
    'Srila Lokanatha Gosvami -- Disappearance':           'Шрила Локанатха Госвами — Уход',
    'Srila Krsnadasa Kaviraja Gosvami -- Disappearance':  'Шрила Кришнадаса Кавираджа Госвами — Уход',
    'Sri Madhvacarya -- Appearance':                      'Шри Мадхвачарья — Явление',
    'Sri Nimbarkacarya -- Appearance':                    'Шри Нимбаркачарья — Явление',
    'Sri Rasikananda -- Appearance':                      'Шри Расикананда — Явление',
    'Sri Locana Dasa Thakura -- Appearance':              'Шри Лочана Дас Тхакур — Явление',
    'Sri Virabhadra -- Appearance':                       'Шри Вирабхадра — Явление',
    'Sri Jagadisa Pandita -- Appearance':                 'Шри Джагадиша Пандит — Явление',
    'Sri Jagadisa Pandita -- Disappearance':              'Шри Джагадиша Пандит — Уход',
    'Sri Bhugarbha Gosvami -- Disappearance':             'Шри Бхугарбха Госвами — Уход',
    'Sri Devananda Pandita -- Disappearance':             'Шри Девананда Пандит — Уход',
    'Sri Dhananjaya Pandita -- Disappearance':            'Шри Дхананджая Пандит — Уход',
    'Sri Gadadhara Dasa Gosvami -- Disappearance':        'Шри Гададхара Даса Госвами — Уход',
    'Sri Gauridasa Pandita -- Disappearance':             'Шри Гауридаса Пандит — Уход',
    'Sri Kaliya Krsnadasa -- Disappearance':              'Шри Калия Кришнадас — Уход',
    'Sri Kasisvara Pandita -- Disappearance':             'Шри Кашишвара Пандит — Уход',
    'Sri Mahesa Pandita -- Disappearance':                'Шри Махеша Пандит — Уход',
    'Sri Murari Gupta -- Disappearance':                  'Шри Мурари Гупта — Уход',
    'Sri Narahari Sarakara Thakura -- Disappearance':     'Шри Нарахари Саракара Тхакур — Уход',
    'Sri Raghunandana Thakura -- Disappearance':          'Шри Рагхунандана Тхакур — Уход',
    'Sri Saranga Thakura -- Disappearance':               'Шри Саранга Тхакур — Уход',
    'Sri Sridhara Pandita -- Disappearance':              'Шри Шридхара Пандит — Уход',
    'Sri Uddharana Datta Thakura -- Disappearance':       'Шри Уддхарана Датта Тхакур — Уход',
    'Sri Vamsidasa Babaji -- Disappearance':              'Шри Вамшидаса Бабаджи — Уход',
    'Sri Vasudeva Ghosh -- Disappearance':                'Шри Васудева Гхош — Уход',
    "Srimati Sita Thakurani (Sri Advaita's consort) -- Appearance":
        'Шримати Сита Тхакурани (супруга Шри Адвайты) — Явление',
    'Nandotsava':                                         'Нандотсава',
    'Sri Visvarupa Mahotsava':                            'Шри Вишварупа-махотсава',
    'Sri Krsna Madhura Utsava':                           'Шри Кришна Мадхура-утсава',
    'Sri Krsna Pusya Abhiseka':                           'Шри Кришна Пушья Абхишека',
    'Sri Krsna Rasayatra':                                'Шри Кришна Расаятра',
    'Sri Krsna Saradiya Rasayatra':                       'Шри Кришна Шарадия Расаятра',
    'Ramacandra Vijayotsava':                             'Рамачандра Виджаётсава',
    'Tulasi-Saligrama Vivaha (marriage)':                 'Туласи-Шалаграма Виваха',
    'Gopastami, Gosthastami':                             'Гопаштами, Гоштхаштами',
    'Gundica Marjana':                                    'Гундича Марджана',
    'Bahulastami':                                        'Бахулаштами',
    'Bali Daityaraja Puja':                               'Бали Даитьяраджа Пуджа',
    'Bhismastami':                                        'Бхишма-аштами',
    'Bhadra Purnima':                                     'Бхадра Пурнима',
    'Vasanta Pancami':                                    'Васанта Панчами',
    'Sarasvati Puja':                                     'Сарасвати Пуджа',
    'Ananta Caturdasi Vrata':                             'Ананта Чатурдаши Врата',
    'Odana sasthi':                                       'Одана Шашти',
    'Siva Ratri':                                         'Шива Ратри',
    'Durga Puja':                                         'Дурга Пуджа',
    'Laksmi Puja':                                        'Лакшми Пуджа',
    'Jagaddhatri Puja':                                   'Джагаддхатри Пуджа',
    'Dipa dana, Dipavali, (Kali Puja)':                   'Дипа-дана, Дипавали (Кали-пуджа)',
    'Advent of Srimad Bhagavad-gita':                     'Появление «Шримад Бхагавад-гиты» (Гита-джаянти)',
    'Acceptance of sannyasa by Srila Prabhupada':         'Принятие санньясы Шрилой Прабхупадой',
    "Srila Prabhupada's arrival in the USA":              'Шрила Прабхупада — прибытие в США',
    "Srila Prabhupada's departure for the USA":           'Шрила Прабхупада — отбытие в США',
    'The incorporation of ISKCON in New York':            'Регистрация ИСККОН в Нью-Йорке',
    'Radha Govinda Jhulana Yatra begins':                 'Начало Радха-Говинда Джхулана-ятры',
    'Jhulana Yatra ends':                                 'Окончание Джхулана-ятры',
    'Katyayani vrata begins':                             'Начало Катьяяни-враты',
    'Katyayani vrata ends':                               'Окончание Катьяяни-враты',
    'First month of Caturmasya begins [PURNIMA SYSTEM]':   'Чатурмасья — первый месяц (система пурнимы)',
    'Second month of Caturmasya begins [PURNIMA SYSTEM]':  'Чатурмасья — второй месяц (система пурнимы)',
    'Third month of Caturmasya begins [PURNIMA SYSTEM]':   'Чатурмасья — третий месяц (система пурнимы)',
    'Fourth month of Caturmasya begins [PURNIMA SYSTEM]':  'Чатурмасья — четвёртый месяц (система пурнимы)',
    'Last day of the first Caturmasya month [PURNIMA SYSTEM]': 'Конец первого месяца чатурмасьи (пурнима)',
    'Last day of the second Caturmasya month [PURNIMA SYSTEM]': 'Конец второго месяца чатурмасьи (пурнима)',
    'Last day of the third Caturmasya month [PURNIMA SYSTEM]': 'Конец третьего месяца чатурмасьи (пурнима)',
    'Last day of the fourth Caturmasya month [PURNIMA SYSTEM]': 'Конец четвёртого месяца чатурмасьи (пурнима)',
}
